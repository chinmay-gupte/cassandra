...
public interface ColumnFamilyStoreMBean
{
    ...
    /**
     * Scan through supplied path to load new SSTables, defaults to data dirs
     * @param path Path from which to load new SSTables
     */
    public void loadNewSSTables(String path);
